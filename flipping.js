...
function point_toucher() {
  ++point_touch;

  if (point_touch == 2 && flip_touch == 5 && time_touch == 2)
    cheat_code();
}
function flip_toucher() {
  ++flip_touch;

  if (point_touch == 2 && flip_touch == 5 && time_touch == 2)
    cheat_code();
}
function time_toucher() {
  ++time_touch;
...
x[0].addEventListener("click", point_toucher);
x[1].addEventListener("click", flip_toucher);
x[2].addEventListener("click", time_toucher);
